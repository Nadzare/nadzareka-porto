...
const projects: Project[] = [
  {
    ...
    description: 'Marketplace batik online terintegrasi peta Leaflet JS dan fitur Generate AI Batik.',
  ...
  },
  {
    ...
    description: 'Challenge project redesain aplikasi Cek Bansos Kemensos berfokus pada kemudahan pengguna.',
  ...
  },
  {
    ...
    description: 'Desain undangan pernikahan digital dan gift card ulang tahun kreatif berbasis website.',
    ...
    <div class="section-container relative z-10">
      ...
      <div ref="headerRef" class="fade-in-up mb-10 text-center">
        ...
        <h2 class="section-title">
          Project <span class="glow-text">Showcase</span>
        </h2>
      ...
      >
        ...
        >
          ...
          <div class="proj-thumb" :style="{ background: project.gradient }">
            ...
            <div
              class="thumb-badge"
              :style="{ background: `${project.accentColor}22`, borderColor: `${project.accentColor}55`, color: project.accentColor }"
            >
              {{ project.category }}
            </div>
      ...
      <div
        ...
        class="text-center py-20 text-slate-500 text-sm"
      >
...
.proj-glow--blue {
  ...
  top: -60px; right: -60px;
  background: radial-gradient(ellipse, rgba(56, 189, 248, .13) 0%, transparent 70%);
...
.proj-card:hover {
  ...
  box-shadow: 0 20px 60px rgba(0, 0, 0, .50), 0 0 0 1px rgba(56, 189, 248, .12);
}
...
.thumb-pattern {
  ...
  background-image:
    ...
    linear-gradient(45deg, transparent 40%, rgba(255,255,255,.03) 100%);
}
...
.thumb-overlay {
  ...
  padding: 1.25rem;
  background: linear-gradient(to top, rgba(7,11,21,.97) 0%, rgba(7,11,21,.88) 55%, transparent 100%);
